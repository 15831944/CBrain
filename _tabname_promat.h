...
#define PARAM_PROMAT_ME_BESTELLT      "bestellt"          //Wert 2
#define PARAM_PROMAT_ME_GELIEFERT     "gelierfert"        //Wert 3
#define PARAM_PROMAT_ME_VERARBEITET   "verarbeitet"       //Wert 4
